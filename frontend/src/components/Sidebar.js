...
function Sidebar() {
  return (
    <div className="w-60 h-full shadow-2xl bg-white px-1 absolute font-sans-new">
      ...
      <Link to="/logout" className="flex relative items-center text-sm py-4 px-6 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-red-600 hover:bg-gray-100 transition duration-300 ease-in-out">

...
function UserLockModal(props) {
        ...
        if (cookie.token) {
            if (userInput === username) {
                try {
                    ...
                    await axios
                        .get(apiPath + "/user/lock/" + props.item.username, config)
                        .then((res) => {
                            if (res.status === 200) {
    ...
    return (
        <div
            ...
            id={"lockstaticBackdrop" + props.item.username}
            ...
            <div className="modal-dialog relative w-auto pointer-events-none">
                <div className="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                    ...
                    <div className="flex flex-col items-start ml-5 gap-3 px-5">
                        ...
                        <p>
                            The user will loose the ability to connect to the application
                            until you unlock him/her.
                        </p>
                        <p>
                            Type{" "}
